        ...
        <div class="top_menu transparent hidden-xs">
            <div class="container">
                <ul class="top_menu_right">
                    <li><i class="fa  fa-phone"></i><a href="tel:18475555555">+62-857-6897-3182 </a></li>
                    <li class="email"><i class="fa  fa-envelope-o "></i> <a href="mailto:danzjuskoikan@gmail.com">danzjuskoikan@gmail.com</a></li>
                    <li class="language-switcher">
                        <nav class="dropdown">
                            <a href="#" class="dropdown-toggle select" data-hover="dropdown" data-toggle="dropdown">
                                <i class="famfamfam-flag-id "></i>Indonesia<b class="caret"></b>
                            </a>
        ...
        <header class="fixed transparent">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand dark nodisplay" href="index">
                    ...
                    <li data-index="rs-214"
                        ...
                        <!-- LAYER NR. 1 -->
                         <div class="tp-caption"
                             ...
                             style="color: #fff; font-weight: 700; font-family: 'Raleway', sans-serif;; ">WELCOME TO GUCI, <span id="text_rotating">PARIWISATA TERBAIK, INSTAGRAMABLE, PEMANDIAN HANGAT</span>
                        </div>
                        <!-- LAYER NR. 2 -->
                        ...
                        <div class="tp-caption tp_m_title"
                             ...
                             data-frames='[{"delay":1750,"speed":1500,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"}]'>Tempat Pariwisata Terbaik Di Kota-Tegal
                        </div>
                        <!-- LAYER NR. 8 -->
                        <div class="tp-caption tp_s_title"
                             ...
                             data-frames='[{"delay":2000,"speed":1500,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"}]'><i class="fa fa-check-square-o"></i> Pelayanan Ramah
                        </div>
                        <!-- LAYER NR. 9 -->
                        <div class="tp-caption tp_s_title"
                             data-visibility="['on','on','on','off']"
                             ...
                             data-fontsize="['20','20','20','15']"
                             data-lineheight="['20','20','20','15']"
                             data-frames='[{"delay":2200,"speed":1500,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"}]'><i class="fa fa-check-square-o"></i> Terdapat Spot Foto Terbaik!
                        </div>
                        <!-- LAYER NR. 10 -->
                        <div class="tp-caption tp_s_title"
                             data-visibility="['on','on','on','off']"
                             ...
                             data-fontsize="['20','20','20','15']"
                             data-lineheight="['20','20','20','15']"
                             data-frames='[{"delay":2400,"speed":1500,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"}]'><i class="fa fa-check-square-o"></i> Mulai Dari Rp 25.000 Per Tiket!
                        </div>
                        <!-- LAYER NR. 11 -->
                        ...
                        <div class="tp-caption"
                            ...
                            <!-- ========== BOOKING FORM ========== -->
                            <div class="vbf">
                                <h2 class="form_title"><i class="fa fa-calendar"></i> Booking Online Sekarang!</h2>
                                <form id="booking-form" class="inner">
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12 nopadding">
                                        <div class="form_select">
                                            <select name="booking-adults" class="form-control md_noborder_right" title="Dewasa" data-header="Dewasa">
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12 nopadding">
                                        <div class="form_select">
                                            <select name="booking-children" class="form-control" title="Anak-Kecil" data-header="Anak-Kecil">
                                                <option value="0">0</option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                    ...
                                    <button type="submit" class="button btn_lg btn_blue btn_full" formaction="boking">BOOK A ROOM NOW</button>
                                    </div>
                                </form>
                            </div>
                        </div>
